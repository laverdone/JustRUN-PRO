...
public class PermissionsWizardFragment2 extends WizardFragment {
	...
	public static PermissionsWizardFragment2 newInstance(String title, String text1, String text2, int iconResId, String[] permission) {
		PermissionsWizardFragment2 f = new PermissionsWizardFragment2();
		Bundle b = new Bundle();
