...
public class PermissionsWizardFragment1 extends WizardFragment {
	...
	public static PermissionsWizardFragment1 newInstance(String title, String text1, String text2, int iconResId, String[] permission) {
		PermissionsWizardFragment1 f = new PermissionsWizardFragment1();
		Bundle b = new Bundle();
